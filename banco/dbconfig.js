...
module.exports = {
  user_o44prdg: process.env.NODE_ORACLEDB_USER || "naturabot",
  user_o68pr: process.env.NODE_ORACLEDB_USER || "naturabot",
  user_o44qxx: process.env.NODE_ORACLEDB_USER || "sisgcp",
  user_o73pr: process.env.NODE_ORACLEDB_USER || "SOA_PREST",

  // Instead of hard coding the password, consider prompting for it,
  // passing it in an environment variable via process.env, or using
  // External Authentication.
  password_o44prdg: process.env.NODE_ORACLEDB_PASSWORD || "Naturabot.01",
  password_o68pr: process.env.NODE_ORACLEDB_PASSWORD || "Naturabot.01",
  password_o44qxx: process.env.NODE_ORACLEDB_PASSWORD || "sisgcp",
  password_o73pr: process.env.NODE_ORACLEDB_PASSWORD || "O73PR_PROD3",
  // For information on connection strings see:
  // https://oracle.github.io/node-oracledb/doc/api.html#connectionstrings
  connectString_o44prdg: process.env.NODE_ORACLEDB_CONNECTIONSTRING || "drp02exacc-scan.natura.com.br:15030/o44prdg",
  connectString_o68pr: process.env.NODE_ORACLEDB_CONNECTIONSTRING || "vipo68svcprd.natura.com.br:15101/o68pr",
  connectString_o44qxx: process.env.NODE_ORACLEDB_CONNECTIONSTRING || "10.224.136.89:1521/o44qxx",
  connectString_o73pr: process.env.NODE_ORACLEDB_CONNECTIONSTRING || "cl04pr-scan.natura.com.br:15101/o73pr",
